    ...
    <div className="h-[175vh] bg-gradient-to-t from-blue-300 to-white-400 font-poppins">
      ...
      <div className="flex items-center justify-between px-28 py-20">
        <div className="flex-col">
          ...
          <p className="text-lg py-4 w-3/4">
            Find easy-to-navigate wheelchair accessible routes throughout your
            city. Our route planner highlights barrier-free paths, ramps, and
            smooth surfaces to help you travel confidently and independently.
          </p>
        </div>
      ...
      <div className="flex justify-evenly m-auto py-14 *:w-[26vw] *:h-[28vw] *:bg-white *:shadow-xl *:rounded-lg">
        <div>
          <h1 className="flex justify-center font-semibold text-4xl pt-6 pb-4">
            Our Mission
          </h1>
          <p className="flex justify-center w-80 m-auto text-lg">
            Our mission is to make navigation easier and safer for everyone,
            especially those with accessibility needs. We aim to provide
            accessible routes, minimizing obstacles and enhancing independence
        ...
        <div>
          ...
          <p className="flex justify-center w-80 m-auto text-lg">
            Using data on path accessibility, this tool identifies routes that
            are wheelchair-friendly by avoiding stairs. Simply input your start
            and final destination, and our route finder will suggest the most
            accessible path for you.
          </p>
        </div>
        <div>
          <h1 className="flex justify-center font-semibold text-4xl pt-6 pb-4">
          ...
          <p className="flex justify-center w-[40vh] m-auto text-lg">
            Over 1.3 billion people worldwide live with some form of disability,
            many of whom face daily challenges with mobility in public spaces.
            Accessible routes not only improve independence and safety but also
